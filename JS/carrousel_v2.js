...
function create_carrousel_main() {
    ...
    if (liste_defilement.length != listBouton.length) {
        ...
        let color_progressBar_def = "rgb(192, 117, 31)";
        let background_color_progressBar_paused = "lightgrey";
        let color_progressBar_paused = "rgb(192, 117, 31)";
        ...
        new_flex.style.left = "50%";
        new_flex.style.transform = "translate(-50%, -50%)";
        ...
        for (let i = liste_defilement.length - 1; i >= 0; i--) {
            ...
            new_button.style.width = "20px";
            new_button.style.height = "20px";
